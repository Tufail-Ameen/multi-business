...
export const PERMISSION_GROUPS = [
  ...
  },
  {
    key: "purchasing",
    label: "Purchasing",
    description: "Vendors, purchases, payments, and ledger",
    permissions: [
      { key: PERMISSIONS.SUPPLIERS_VIEW, label: "View vendors" },
      { key: PERMISSIONS.SUPPLIERS_CREATE, label: "Create vendors" },
      { key: PERMISSIONS.SUPPLIERS_UPDATE, label: "Update vendors" },
      { key: PERMISSIONS.SUPPLIERS_DELETE, label: "Delete vendors" },
      ...
      { key: PERMISSIONS.SUPPLIER_PAYMENTS_VIEW, label: "View vendor payments" },
      { key: PERMISSIONS.SUPPLIER_PAYMENTS_CREATE, label: "Record vendor payments" },
      { key: PERMISSIONS.SUPPLIER_LEDGER_VIEW, label: "View vendor ledger" },
    ],
  },
  {
    key: "team",
